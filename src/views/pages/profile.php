                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="user-info-mini">
                                ...
                                <?=date('d/m/Y', strtotime($user->birthdate));?> (<?=$user->yearsOld;?> anos)
                            </div>
                    ...
                    <div class="box">
                        <div class="box-header m-10">
                            ...
                            <div class="box-header-buttons">
                                <a href="<?=$base;?>/perfil/<?=$user->id;?>/amigos?to=following">ver todos</a>
                            </div>
                        </div>
                        <div class="box-body friend-list">

                            <?php for($q=0;$q<9;$q++): ?>
                                <?php if(isset($user->followings[$q])): ?>
                                    <div class="friend-icon">
                                        <a href="<?=$base;?>/perfil/<?=$user->followings[$q]->id;?>">
                                            <div class="friend-icon-avatar">
                                                <img src="<?=$base;?>/media/avatars/<?=$user->followings[$q]->avatar?>" />
                                            </div>
                                            <div class="friend-icon-name">
                                                <?=$user->followings[$q]->name?>
                                            </div>
                                        </a>
                                    </div>
                                <?php endif; ?>
                ...
                <div class="column pl-5">
                    ...
                    <div class="feed-pagination">
                        <?php for($q=0;$q<$feed['totalPages'];$q++): ?>
                            <a href="<?=$base;?>/perfil/<?=$user->id?>?page=<?=$q;?>" class="<?php echo ($feed['currentPage'] == ($q)) ? 'active' : ''; ?>"><?=$q+1;?></a>
                        <?php endfor; ?>
                    </div>
